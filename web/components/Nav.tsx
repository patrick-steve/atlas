      ...
      <div className="mx-auto max-w-[1400px] flex items-center justify-between px-4 sm:px-6 py-3 gap-6">
        <a href="#hero" className="flex items-center gap-3 min-w-0 group">
          <Image
            ...
            priority
          />
          <span className="font-mono text-sm tracking-widest text-mute-50 whitespace-nowrap">
            ATLAS<span className="text-mute-300/70 ml-2">::</span>
            <span className="text-mute-200 ml-2 hidden xl:inline">DISTRIBUTED ZK PROVING</span>
          </span>
        </a>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden sm:inline-flex items-center gap-2 border border-signal/40 px-2.5 py-1 font-mono text-[10px] tracking-widest text-signal hover:bg-signal/10 transition-colors whitespace-nowrap"
          >
          ...
          <div className="font-mono text-[10px] tracking-widest text-mute-300 hidden 2xl:block whitespace-nowrap">
